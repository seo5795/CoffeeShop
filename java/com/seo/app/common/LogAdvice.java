...
public class LogAdvice {
	@Before("PointcutCommon.aPointcut()")// 어드바이스의 동작시점을 설정하는 @
	...
	@AfterReturning(pointcut="PointcutCommon.bPointcut()",returning="returnObj")// 어드바이스의 동작시점을 설정하는 @
	...
	public void atLog(JoinPoint jp,Exception excepObj) {
		...
		if(excepObj instanceof NumberFormatException) { // 예외 확인후 추가가능
